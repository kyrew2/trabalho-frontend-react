...
export function Register() {
    ...
    return (
        <div className="min-h-screen bg-[#2B2B24] relative">
            ...
            {/* --- CAMADA DE ANIMAÇÃO (FIXA NO FUNDO) --- */}
            {/* 'fixed inset-0 overflow-hidden' garante que a animação não crie scrollbars indesejados */}
            ...
            {/* --- CONTEÚDO ROLÁVEL --- */}
            {/* 'flex min-h-screen' permite centralizar, mas deixa rolar se necessário */}
